    ...
    return (
      <View style={styles.subDetailsContainer}>
        ...
        <Dialog.Container visible={isShowDialog}>
          ...
          <View style={styles.inputBox}>
            <TextInput
              onEndEditing={(event) => {
                ...
                if (date.isValid()) expenditure.date = date
              }}
              onFocus={() => {
          ...
          <Dialog.Button label={strings.delete} onPress={handleDelete} />
          <Dialog.Button label={strings.save} onPress={handleUpdate} />
          {isShowDatePicker ? (
            <DateTimePicker
      ...
      >
        ...
        {isOpen
          ? expenditureList.map((expenditure) => {
              return (
                <SubDetails key={expenditure._id} expenditure={expenditure} />
              )
            })
          : null}
      </View>
    ...
    return (
      <View style={styles.bottomBar}>
        ...
        <Dialog.Container visible={isShowDialog}>
          ...
          <Dialog.Button label={strings.cancel} onPress={handleCancel} />
          <Dialog.Button label={strings.add} onPress={handelAdd} />
